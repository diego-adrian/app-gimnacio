	...
	<div class="main-content">
					...
					<div class="m-form-buttons">
						<div class="m-form-buttons__button a-button--with-gradient-hover a-button--big a-button gradient-naranja">
							<div data-href="/3" class="a-button__link dietAnswer" data-key="1163" data-value="1091"
								...
								<div class="a-button__text font-size-18">CASI NINGUNA ACTIVIDAD FÍSICA <div class="mini-circle-inicial"></div></div>
							</div>
						</div>
						<div class="m-form-buttons__button a-button--with-gradient-hover a-button--big a-button gradient-naranja">
							<div data-href="/3" class="a-button__link dietAnswer" data-key="1163" data-value="1092"
								...
								<div class="a-button__text font-size-18">A MENUDO VOY A PASEAR</div>
							</div>
						</div>
						<div class="m-form-buttons__button a-button--with-gradient-hover a-button--big a-button gradient-naranja">
							<div data-href="/3" class="a-button__link dietAnswer" data-key="1163" data-value="1093"
								...
								<div class="a-button__text font-size-18"> <div class="mini-circle-medio"></div>HAGO EJERCICIOS 1 - 2 VECES A LA SEMANA</div>
							</div>
						</div>
						<div class="m-form-buttons__button a-button--with-gradient-hover a-button--big a-button gradient-naranja">
							<div data-href="/3" class="a-button__link dietAnswer" data-key="1163" data-value="1094"
								...
								<div class="a-button__text font-size-18">HAGO EJERCICIOS DE 3 - 5 VECES A LA SEMANA</div>
							</div>
						</div>
						<div class="m-form-buttons__button a-button--with-gradient-hover a-button--big a-button gradient-naranja">
							<div data-href="/3" class="a-button__link dietAnswer" data-key="1163" data-value="1095"
								...
								<div class="a-button__text font-size-18">HAGO EJERCICIOS DE 5 - 7 VECES A LA SEMANA <div class="mini-circle-final"></div></div>
							</div>
						</div>
					</div>
				</div>
        ...
        ">
					<div
						...
						<div class="m-progress-bar__percent"><span class="js-progress-percent font-size-16">13</span><span>%</span></div>
